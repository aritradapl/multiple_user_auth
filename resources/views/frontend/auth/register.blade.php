<link rel="stylesheet" href="{{asset('frontend/auth/css/index.css')}}">
<link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/bootstrap@4.0.0/dist/css/bootstrap.min.css" integrity="sha384-Gn5384xqQ1aoWXA+058RXPxPg6fy4IWvTNh0E263XmFcJlSAwiGgFAW/dAiS6JXm" crossorigin="anonymous">
<meta name="csrf-token" content="{{ csrf_token() }}">
<div class="container-fluid px-1 py-5 mx-auto">
    <div class="row d-flex justify-content-center">
        <div class="col-xl-7 col-lg-8 col-md-9 col-11 text-center">
            <h5 class="text-center mb-4"><u><b>User Registration</u></b></h5>
            <form class="form-card" action="{{route('user.register.post')}}" method="post">
                {{ csrf_field() }}
                ...
                <div class="row justify-content-between text-left">
                    <div class="form-group col-sm-6 flex-column d-flex"> 
                        ...
                        <p>Dont Have Any Account?<a href="{{route('user.login')}}">SIGN IN</a></p> 
                    </div>
                </div>
            </form>
        </div>
